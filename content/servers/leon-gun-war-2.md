...
※当サーバーは<span style="font-size: 20px"><strong>LeonGunWarの後継サーバー</span></strong>です！！<br>
# LeonGunWar2鯖とは (バージョン1.16.5)
LeonGunWar2は、無料で遊べるFPS(ファーストパーソン・シューティング)のサーバーです。<br>
LeonGunWar2サーバーではチームデスマッチやリーダーデスマッチのPvPを基本とし、イベントの際にはそれと別にFFA(個人戦)やPvEなど色々な楽しみ方があります！<br>
...
- 特殊アタッチメントを装着できる武器は名前変更不可。
- ※モード切替が可能な武器およびソーサラーロッド系ではネームドコインを右クリックして行うネームドを行わないでください。discord上のチャンネルで対応します。
